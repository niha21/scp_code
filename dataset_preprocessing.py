...
def load_tic_tac_toe_dataset():
    data = []
    # Read the training data
    file = open('data/tic-tac-toe.data')
    reader = csv.reader(file, delimiter=',')
